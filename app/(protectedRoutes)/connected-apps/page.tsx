...
export default async function ConnectedAppsPage() {
  ...
  return (
    <main className="p-4 md:p-6 max-w-3xl mx-auto space-y-6">
      ...
      {/* Adjusted padding to match other pages */}
      {/* Centering title and main description */}
      <h1 className="text-3xl font-semibold">Grant Application Permissions</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select an application and the private identities you wish to grant
            it access to. Currently, this will grant read-only access to the
            selected identity profiles.
          </CardDescription>
        </CardHeader>
        <CardContent>
